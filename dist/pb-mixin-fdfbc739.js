 ...
 * @mixinFunction
 */
const pbMixin = superclass => class PbMixin extends superclass {
  ...
  waitForChannel(callback) {
    ...
    } else if (this.subscribe && readyEventsFired.has(this.subscribe) || !this.subscribe && readyEventsFired.has('__default__')) {
      return callback();
    }
...
export { AttributePart as A, LitElement as L, NodePart as N, _objectSpread2 as _, createMarker as a, removeNodes as b, css as c, directive as d, html as h, isPrimitive as i, pbMixin as p, reparentNodes as r };
//# sourceMappingURL=pb-mixin-fdfbc739.js.map
