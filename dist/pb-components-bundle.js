import{d as e,P as t,h as n,t as i,i as r,I as o,a,b as s,D as l,c,e as d,G as p,f as u,g as h,r as g}from"./paper-inky-focus-behavior-b5e152b3.js";import{P as f,I as m,a as b,b as v,c as y,d as w,N as _,e as x,f as k}from"./paper-checkbox-d6ebdce3.js";import{u as A,p as S,P as E,E as T,T as C}from"./pb-code-editor-93d9a993.js";import{L,h as R,c as O,_ as z,p as P}from"./pb-mixin-fdfbc739.js";import{r as I}from"./utils-f6f2f825.js";import"./iron-form-1f9fbdaa.js";import"./paper-icon-button-79f9c0ff.js";
/**
@license
...
`,is:"paper-icon-item",behaviors:[E]});class xr extends(P(L)){static get properties(){return z(z({},super.properties),{},{name:{type:String},label:{type:String},selected:{type:Number},items:{type:Array}})}constructor(){super(),this.initializing=!0,this.items=[],this.label="document.selectFeature"}connectedCallback(){super.connectedCallback();const e=this.getParameter(this.name);void 0!==e?this.selected=parseInt(e,10):this.items.length>0&&(this.selected=0),this.waitForChannel(()=>{this.selected&&this.selected<this.items.length&&this._emit("init",this.selected),this.initializing=!1,this.signalReady()})}firstUpdated(){super.firstUpdated(),this.shadowRoot.getElementById("menu").addEventListener("selected-item-changed",this._selectionChanged.bind(this))}_selectionChanged(){const e=this.shadowRoot.getElementById("list").selected;this.setParameter(this.name,e),this.pushHistory("toggle feature "+this.name),console.log("<pb-select-feature> Setting features: %o",this.items[e]),this._emit("refresh",e)}_emit(e,t){const n=this.items[t],i={properties:n.properties||{},selectors:n.selectors,action:e};this.emitTo("pb-toggle",i)}render(){return R`
        ...
        `}render(){return R`
            ...
            <iron-ajax
                ...
                @response="${this._handleContent}"
                @error="${this._handleError}"></iron-ajax>
      `}}customElements.define("pb-view",Go);class Xo extends(P(L)){static get properties(){return z(z({},super.properties),{},{icon:{type:String},direction:{type:String}})}constructor(){super(),this.icon="icons:zoom-in",this.direction="in"}connectedCallback(){super.connectedCallback()}_handleClick(){this.emitTo("pb-zoom",{direction:this.direction})}render(){return R`
            <paper-icon-button icon="${this.icon}" @click="${this._handleClick}"></paper-icon-button>
        `}}customElements.define("pb-zoom",Xo);class Zo extends(P(L)){static get properties(){return z(z({},super.properties),{},{toggle:{type:String},opened:{type:Boolean,reflect:!0},maxWidth:{type:String,attribute:"max-width"}})}constructor(){super(),this.opened=!1}connectedCallback(){super.connectedCallback();const e=document.getElementById(this.toggle);e&&e.addEventListener("click",this._toggle.bind(this)),document.body.addEventListener("click",t=>{t.target!==e&&this.opened&&(this.opened=!1)}),this.addEventListener("click",e=>e.stopPropagation()),this.subscribeTo("pb-refresh",this._close.bind(this))}firstUpdated(){this.maxWidth?(void 0!==window.visualViewport?window.visualViewport.addEventListener("resize",()=>{this._handleResize()}):window.addEventListener("resize",()=>{this._handleResize()}),this._handleResize()):this.classList.add("overlay")}_handleResize(){const e=document.getElementById(this.toggle),t=`(max-width: ${this.maxWidth})`;window.matchMedia(t).matches?(console.log("<pb-drawer> entering overlay mode"),this.classList.add("overlay"),e&&(e.style.display="")):(console.log("<pb-drawer> leaving overlay mode"),this.classList.remove("overlay"),e&&(e.style.display="none"))}_toggle(e){e.preventDefault(),this.opened?this.opened=!1:(this.opened=!0,this.emitTo("pb-load"))}_close(){this.opened=!1}render(){return R`
            <div><slot></slot></div>
        `}static get styles(){return O`
            :host {
                display: block;
        ...
        `}}customElements.define("pb-drawer",Zo);class Qo extends L{static get properties(){return z(z({},super.properties),{},{query:{type:String},match:{type:Boolean,reflect:!0}})}constructor(){super(),this.query="(max-width:460px)",this.match=!1}firstUpdated(){void 0!==window.visualViewport?window.visualViewport.addEventListener("resize",()=>{this._handleResize()}):window.addEventListener("resize",()=>{this._handleResize()}),this._handleResize()}_handleResize(){let{query:e}=this;/\(.*\)$/.test(e)||(e=`(${e})`),window.matchMedia(e).matches?!1===this.match&&(this.dispatchEvent(new CustomEvent("changed",{detail:{value:!0},composed:!0,bubbles:!0})),this.match=!0):!0===this.match&&(this.dispatchEvent(new CustomEvent("changed",{detail:{value:!1},composed:!0,bubbles:!0})),this.match=!1)}render(){return R`
            ${this.match?R`<slot></slot>`:null}
        `}static get styles(){return O`
            :host {
                display: inherit;
            }
        `}}customElements.define("pb-media-query",Qo);class Yo extends Fn{firstUpdated(){this.shadowRoot.getElementById("ironform").addEventListener("iron-form-presubmit",e=>{e.preventDefault(),this._submit()})}render(){return R`
...
t({_template:n`
    ...
    <slot></slot>
`,is:"iron-pages",behaviors:[b,y],properties:{activateEvent:{type:String,value:null}},observers:["_selectedPageChanged(selected)"],_selectedPageChanged:function(e,t){this.async(this.notifyResize)}});class ia extends(P(L)){static get properties(){return z(z({},super.properties),{},{selected:{type:Number,reflect:!0},_initial:{type:Number}})}constructor(){super(),this._initial=this.getParameter("tab",0),this.selected=this._initial}_switchTab(e){this.selected=e.detail.value,this.setParameter("tab",this.selected),this.pushHistory("browse",{tab:this.selected})}render(){return R`
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class ma extends(T(fa(C(p(u))))){static get template(){return n`
    <style>
      :host {
        display: inline-block;
        position: relative;
...
`}static get is(){return"vaadin-button"}static get version(){return"2.4.0"}ready(){super.ready(),this.setAttribute("role","button"),this.$.button.setAttribute("role","presentation"),this._addActiveListeners(),window.ShadyDOM&&window.ShadyDOM.flush()}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("active")&&this.removeAttribute("active")}_addActiveListeners(){h(this,"down",()=>!this.disabled&&this.setAttribute("active","")),h(this,"up",()=>this.removeAttribute("active")),this.addEventListener("keydown",e=>!this.disabled&&[13,32].indexOf(e.keyCode)>=0&&this.setAttribute("active","")),this.addEventListener("keyup",()=>this.removeAttribute("active")),this.addEventListener("blur",()=>this.removeAttribute("active"))}get focusElement(){return this.$.button}}customElements.define(ma.is,ma);const ba=n`<dom-module id="lumo-progress-bar" theme-for="vaadin-progress-bar">
  <template>
    <style>
      :host {
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class ya extends(T(C(va(u)))){static get template(){return n`
    <style>
      :host {
        display: block;
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
class xa extends(C(u)){static get template(){return n`
    <style>
      :host {
        display: block;
      }
...
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
class ka extends(T(C(u))){static get template(){return n`
    <style>
      :host {
        display: block;
        position: relative;
...
found at http://polymer.github.io/PATENTS.txt
*/
t({is:"transform-animation",behaviors:[k],configure:function(e){var t=e.node,n=e.transformFrom||"none",i=e.transformTo||"none";return this._effect=new KeyframeEffect(t,[{transform:n},{transform:i}],this.timingFromConfig(e)),e.transformOrigin&&this.setPrefixedProperty(t,"transformOrigin",e.transformOrigin),this._effect}});class Ca extends(P(L)){static get properties(){return z(z({},super.properties),{},{label:{type:String},odds:{type:Array},name:{type:String},odd:{type:String,notify:!0}})}constructor(){super(),this.label="document.selectODD",this.odds=[]}connectedCallback(){super.connectedCallback(),this.subscribeTo("pb-update",this._onTargetUpdate.bind(this))}firstUpdated(){super.firstUpdated(),this._refresh()}render(){return R`
