import { d as directive, N as NodePart, a as createMarker, r as reparentNodes, b as removeNodes, A as AttributePart, L as LitElement, c as css, h as html$1, _ as _objectSpread2, p as pbMixin } from './pb-mixin-fdfbc739.js';
import { E as ElementMixin, T as ThemableMixin, D as DirHelper, u as unsafeHTML, p as pbHotkeys } from './pb-code-editor-93d9a993.js';
import { h as html, f as PolymerElement, F as FlattenedNodesObserver, D as Debouncer, C as timeOut, E as mixinBehaviors, t as translate, p as get } from './paper-inky-focus-behavior-b5e152b3.js';
import { d as afterNextRender, a as IronResizableBehavior } from './paper-checkbox-d6ebdce3.js';
import './paper-icon-button-79f9c0ff.js';
import './utils-f6f2f825.js';
...
const $_documentContainer$1 = html`<dom-module id="lumo-tab" theme-for="vaadin-tab">
  <template>
    <style>
      :host {
...
class PbOddModelEditor extends LitElement {
  ...
  constructor() {
    ...
    this.parentModel = [];
    this.behaviours = ["alternate", "anchor", "block", "body", "break", "cell", "cit", "document", "figure", "graphic", "heading", "inline", "link", "list", "listItem", "metadata", "note", "omit", "paragraph", "row", "section", "table", "text", "title", "webcomponent"];
...
class PbOddEditor extends pbHotkeys(pbMixin(LitElement)) {
  ...
  serializeModel(indent, model) {
    ...
    const attributes = [this.serializeAttribute('output', model.output), this.serializeAttribute('predicate', model.predicate), model.type === 'model' ? this.serializeAttribute('behaviour', model.behaviour) : '', this.serializeAttribute('cssClass', model.css), this.serializeAttribute('useSourceRendition', model.sourcerend)].join('');
