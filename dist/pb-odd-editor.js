import{d as e,N as t,a as o,r as i,b as s,A as r,L as a,c as n,h as d,_ as l,p as c}from"./pb-mixin-fdfbc739.js";import{E as p,T as h,D as m,u,p as b}from"./pb-code-editor-93d9a993.js";import{h as g,f as v,F as f,D as w,C as y,E as _,t as x,p as E}from"./paper-inky-focus-behavior-b5e152b3.js";import{d as $,a as S}from"./paper-checkbox-d6ebdce3.js";import"./paper-icon-button-79f9c0ff.js";import"./utils-f6f2f825.js";
/**
 * @license
 ...
 */
const C=(e,i)=>{const s=e.startNode.parentNode,r=void 0===i?e.endNode:i.startNode,a=s.insertBefore(o(),r);s.insertBefore(o(),r);const n=new t(e.options);return n.insertAfterNode(a),n},k=(e,t)=>(e.setValue(t),e.commit(),e),A=(e,t,o)=>{const s=e.startNode.parentNode,r=o?o.startNode:e.endNode,a=t.endNode.nextSibling;a!==r&&i(s,t.startNode,a,r)},R=e=>{s(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},M=(e,t,o)=>{const i=new Map;for(let s=t;s<=o;s++)i.set(e[s],s);return i},I=new WeakMap,B=new WeakMap,O=e((e,o,i)=>{let s;return void 0===i?i=o:void 0!==o&&(s=o),o=>{if(!(o instanceof t))throw new Error("repeat can only be used in text bindings");const r=I.get(o)||[],a=B.get(o)||[],n=[],d=[],l=[];let c,p,h=0;for(const t of e)l[h]=s?s(t,h):h,d[h]=i(t,h),h++;let m=0,u=r.length-1,b=0,g=d.length-1;for(;m<=u&&b<=g;)if(null===r[m])m++;else if(null===r[u])u--;else if(a[m]===l[b])n[b]=k(r[m],d[b]),m++,b++;else if(a[u]===l[g])n[g]=k(r[u],d[g]),u--,g--;else if(a[m]===l[g])n[g]=k(r[m],d[g]),A(o,r[m],n[g+1]),m++,g--;else if(a[u]===l[b])n[b]=k(r[u],d[b]),A(o,r[u],r[m]),u--,b++;else if(void 0===c&&(c=M(l,b,g),p=M(a,m,u)),c.has(a[m]))if(c.has(a[u])){const e=p.get(l[b]),t=void 0!==e?r[e]:null;if(null===t){const e=C(o,r[m]);k(e,d[b]),n[b]=e}else n[b]=k(t,d[b]),A(o,t,r[m]),r[e]=null;b++}else R(r[u]),u--;else R(r[m]),m++;for(;b<=g;){const e=C(o,n[g+1]);k(e,d[b]),n[b++]=e}for(;m<=u;){const e=r[m++];null!==e&&R(e)}I.set(o,n),B.set(o,l)}}),z=new WeakMap,P=e(e=>t=>{const o=z.get(t);if(void 0===e&&t instanceof r){if(void 0!==o||!z.has(t)){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else e!==o&&t.setValue(e);z.set(t,e)}),T=g`<dom-module id="lumo-tab" theme-for="vaadin-tab">
  <template>
    <style>
      :host {
...
`}static get is(){return"vaadin-tabs"}static get version(){return"3.2.0"}static get properties(){return{orientation:{value:"horizontal",type:String},selected:{value:0,type:Number}}}static get observers(){return["_updateOverflow(items.*, vertical)"]}ready(){super.ready(),this.addEventListener("iron-resize",()=>this._updateOverflow()),this._scrollerElement.addEventListener("scroll",()=>this._updateOverflow()),this.setAttribute("role","tablist"),$(this,()=>{this._updateOverflow()})}_scrollForward(){this._scroll(-this.__direction*this._scrollOffset)}_scrollBack(){this._scroll(this.__direction*this._scrollOffset)}get _scrollOffset(){return this._vertical?this._scrollerElement.offsetHeight:this._scrollerElement.offsetWidth}get _scrollerElement(){return this.$.scroll}get __direction(){return this._vertical||"rtl"!==this.getAttribute("dir")?-1:1}_updateOverflow(){const e=this._vertical?this._scrollerElement.scrollTop:this.__getNormalizedScrollLeft(this._scrollerElement);let t=this._vertical?this._scrollerElement.scrollHeight:this._scrollerElement.scrollWidth;t-=1;let o=e>0?"start":"";o+=e+this._scrollOffset<t?" end":"",1==this.__direction&&(o=o.replace(/start|end/gi,e=>"start"===e?"end":"start")),o?this.setAttribute("overflow",o.trim()):this.removeAttribute("overflow"),this._repaintShadowNodesHack()}_repaintShadowNodesHack(){if(D&&this.root){const e="-webkit-backface-visibility";this.root.querySelectorAll("*").forEach(t=>{t.style[e]="visible",t.style[e]=""})}}}customElements.define(U.is,U);class F extends a{static get styles(){return n`
        ...
        `}static get properties(){return{title:{type:String,reflect:!0},type:{type:String},message:{type:String,reflect:!0}}}constructor(){super(),this.title="",this.message="",this.type="message"}render(){return d`
        <paper-dialog id="modal">
            <h2 id="title">${this.title}</h2>
            <paper-dialog-scrollable id="message" class="message" tabindex="0">${u(this.message)}</paper-dialog-scrollable>

            <div class="buttons">
                <paper-button dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isConfirm()}">${x("dialogs.close")}</paper-button>
                <paper-button id="confirm" dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isMessage()}">${x("dialogs.yes")}</paper-button>
                <paper-button id="reject" dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isMessage()}">${x("dialogs.no")}</paper-button>
            </div>
        </paper-dialog>
        `}firstUpdated(){this.modal=this.shadowRoot.getElementById("modal")}show(e,t){this.type="message",this.set(e,t),this.modal.noCancelOnOutsideClick=!1,this.modal.noCancelOnEscKey=!1,this.modal.open()}confirm(e,t){this.type="confirm",this.set(e,t),this.modal.noCancelOnOutsideClick=!0,this.modal.noCancelOnEscKey=!0,this.modal.open();const o=this.shadowRoot.getElementById("confirm"),i=this.shadowRoot.getElementById("reject");return new Promise((e,t)=>{o.addEventListener("click",e,{once:!0}),i.addEventListener("click",t,{once:!0})})}set(e,t){this.title=e,this.message=t,this.modal.notifyResize()}isMessage(){return"message"===this.type}isConfirm(){return"confirm"===this.type}}customElements.define("pb-message",F);class H extends a{static get styles(){return n`
            :host {
                display: block;
            }
            .wrapper{
        ...
        <div class="wrapper">
            ...
            <paper-autocomplete id="combo" text="${this.name}" placeholder="${x("odd.editor.model.param-name-placeholder")}" label="Name" 
        ...
        `}static get properties(){return{behaviour:{type:String},predicate:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},type:{type:String,reflect:!0},template:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},output:{type:String,reflect:!0,converter:(e,t)=>"null"===e.toLowerCase()?"":e},css:{type:String,converter:(e,t)=>"null"===e.toLowerCase()?"":e},model:{type:Object},models:{type:Array},parameters:{type:Array},renditions:{type:Array},desc:{type:String,converter:(e,t)=>"null"===e.toLowerCase()?"":e},sourcerend:{type:String},show:{type:Boolean,reflect:!0},outputs:{type:Array},behaviours:{type:Array},icon:{type:String},open:{type:String},hasCustomBehaviour:{type:Boolean},endpoint:{type:String}}}constructor(){super(),this.behaviour="inline",this.predicate="",this.type="",this.template="",this.output="",this.css="",this.model={},this.model.models=[],this.parameters=[],this.renditions=[],this.desc="",this.sourcerend="",this.show=!1,this.outputs=["","web","print","epub","fo","latex","plain"],this.parentModel=[],this.behaviours=["alternate","anchor","block","body","break","cell","cit","document","figure","graphic","heading","inline","link","list","listItem","metadata","note","omit","paragraph","row","section","table","text","title","webcomponent"],this.icon="expand-more",this.hasCustomBehaviour=!1}render(){return d`
        <form>
            <header> 
                <h4>
                        ...
                        ${this._isGroupOrSequence()?d`
                            <paper-menu-button horizontal-align="right">
                                ...
                                <paper-listbox id="modelType" slot="dropdown-content" @iron-select="${this._addNested}"
                                   ...
                                   ${"modelSequence"===this.type?d`
                                            <paper-item value="model">model</paper-item>
                                        `:""}
                                   ${"modelGrp"===this.type?d`
            ...
            <iron-collapse id="details" ?opened="${this.show}" class="details">
                ...
                <paper-input id="desc" .value="${this.desc}" placeholder="${x("odd.editor.model.description-placeholder")}"
                ...
                <pb-code-editor id="predicate"
                     ...
                     label="Predicate"
                     placeholder="${x("odd.editor.model.predicate-placeholder")}"
                ...
                ${this._isModel()?d`
                        <div>
                            <div class="behaviourWrapper">
                                <paper-dropdown-menu label="behaviour" id="behaviourMenu" ?disabled="${this.hasCustomBehaviour}">
                                    <paper-listbox id="behaviour" slot="dropdown-content" attr-for-selected="value"
                                        ...
                                        ${this.behaviours.map(e=>d`
                                            <paper-item value="${e}">${e}</paper-item>
                                        `)}
                                    </paper-listbox>
                                </paper-dropdown-menu>
                                <span style="align-self:center;justify-self: center;"> ${x("odd.editor.model.link-with-or")} </span>
                                <paper-input id="custombehaviour" label="" @input="${this._handleCustomBehaviour}" placeHolder="${x("odd.editor.model.custom-behaviour-placeholder")}"></paper-input>
                                <span></span>
                            </div>
                            ...
                            <paper-input id="css" .value="${this.css}"
                                placeholder="${x("odd.editor.model.css-class-placeholder")}"
                                label="CSS Class"
                            ...
                            <pb-code-editor id="template"
                                             ...
                                             label="Template"
                                             placeholder="${x("odd.editor.model.template-placeholder")}"
                        ...
                        <div class="parameters">
                            ...
                            ${O(this.parameters,e=>e.name,(e,t)=>d`
                        ...
                        <div class="renditions">
                            ...
                            ${O(this.renditions,e=>e.name,(e,t)=>d`
        ...
        `}static get properties(){return{ident:{type:String},mode:{type:String},models:{type:Array},endpoint:{type:String}}}constructor(){super(),this.ident="",this.mode="",this.models=[],this.icon="expand-more"}render(){return d`   
        <h3>
        ...
        <div id="layout">
            <div id="drawer">
                    ...
                    <h3>
                        ...
                        <span class="icons">
                            <pb-edit-xml id="editSource"><paper-icon-button icon="code" title="${x("odd.editor.odd-source")}"></paper-icon-button></pb-edit-xml>
                            <paper-icon-button @click="${this._reload}" icon="refresh" title="${x("odd.editor.reload")}"></paper-icon-button>
                            <paper-icon-button @click="${this.save}" icon="save" title="${x("odd.editor.save")} ${this.display("save")}" 
                                ?disabled="${!this.loggedIn}"></paper-icon-button>
                        </span>
                    </h3>
                    <div id="new-element" class="input-group">
                        <paper-input id="identNew" label="${x("odd.editor.add-element")}" always-float-label="always-float-label">
                            <paper-icon-button slot="suffix" @click="${this.addElementSpec}" icon="add" tabindex="-1"></paper-icon-button>
                        </paper-input>
                    </div>

                    <div id="jump-to">
                        <paper-autocomplete id="jumpTo" label="${x("odd.editor.jump-to")}" always-float-label="always-float-label"></paper-autocomplete>
                    </div>
                    
                    <h3>${x("odd.editor.specs")}</h3>
            </div>
            <div id="navlist">
                ${O(this.elementSpecs,e=>e.ident,(e,t)=>d`
                ...
                <paper-card class="metadata">
                    <pb-collapse id="meta">
                        ...
                        <div slot="collapse-content">
                            <paper-input id="title" name="title" value="${this.title}" label="${x("odd.editor.title")}"
                                         placeholder="[${x("odd.editor.title-placeholder")}]"
                                         @change="${this._inputTitle}"></paper-input>
                            <paper-input id="titleShort" name="short-title" .value="${this.titleShort}" label="${x("odd.editor.title-short")}"
                                         placeholder="[${x("odd.editor.title-short-placeholder")}]"
                                         @change="${e=>this.titleShort=e.composedPath()[0].value}"></paper-input>
                            <paper-input id="description" name="description" .value="${P(this.description)}" label="${x("odd.editor.description-label")}"
                                      placeholder="[${x("odd.editor.description-placeholder")}]"
                                      @change="${e=>this.description=e.composedPath()[0].value}"></paper-input>
                            <paper-input id="source" name="source" ?value="${this.source}" label="${x("odd.editor.source-label")}"
                                         placeholder="[${x("odd.editor.source-placeholder")}]"
                                         @change="${e=>this.source=e.composedPath()[0].value}"></paper-input>
                            <paper-checkbox id="useNamespace" @change="${this.setUseNamespace}">${x("odd.editor.use-namespace")}</paper-checkbox>
                            <paper-input id="namespace" name="namespace" value="${this.namespace}" label="Namespace" ?disabled="${!this.useNamespace}"
                                         placeholder="[${x("odd.editor.namespace-placeholder")}]"
                            ...
                            <div class="extCssEdit">
                                ...
                                <pb-edit-xml id="editCSS"><paper-icon-button icon="create" title="${x("odd.editor.css-source")}"></paper-icon-button></pb-edit-xml>
                            </div>
                        </div>
                    </pb-collapse>
                </paper-card>
