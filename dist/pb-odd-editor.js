import{d as e,N as t,a as o,r as i,b as s,A as r,L as a,c as n,h as d,_ as l,p as c}from"./pb-mixin-fdfbc739.js";import{E as p,T as h,D as m,u,p as g}from"./pb-code-editor-bd6ed9c6.js";import{h as b,m as v,F as f,D as w,y,z as _,j as x,f as E}from"./paper-checkbox-768b7c41.js";import{t as $,g as S}from"./pb-i18n-d9476838.js";import"./utils-f6f2f825.js";
/**
 * @license
 ...
 */
const C=(e,i)=>{const s=e.startNode.parentNode,r=void 0===i?e.endNode:i.startNode,a=s.insertBefore(o(),r);s.insertBefore(o(),r);const n=new t(e.options);return n.insertAfterNode(a),n},k=(e,t)=>(e.setValue(t),e.commit(),e),A=(e,t,o)=>{const s=e.startNode.parentNode,r=o?o.startNode:e.endNode,a=t.endNode.nextSibling;a!==r&&i(s,t.startNode,a,r)},R=e=>{s(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},M=(e,t,o)=>{const i=new Map;for(let s=t;s<=o;s++)i.set(e[s],s);return i},I=new WeakMap,B=new WeakMap,O=e((e,o,i)=>{let s;return void 0===i?i=o:void 0!==o&&(s=o),o=>{if(!(o instanceof t))throw new Error("repeat can only be used in text bindings");const r=I.get(o)||[],a=B.get(o)||[],n=[],d=[],l=[];let c,p,h=0;for(const t of e)l[h]=s?s(t,h):h,d[h]=i(t,h),h++;let m=0,u=r.length-1,g=0,b=d.length-1;for(;m<=u&&g<=b;)if(null===r[m])m++;else if(null===r[u])u--;else if(a[m]===l[g])n[g]=k(r[m],d[g]),m++,g++;else if(a[u]===l[b])n[b]=k(r[u],d[b]),u--,b--;else if(a[m]===l[b])n[b]=k(r[m],d[b]),A(o,r[m],n[b+1]),m++,b--;else if(a[u]===l[g])n[g]=k(r[u],d[g]),A(o,r[u],r[m]),u--,g++;else if(void 0===c&&(c=M(l,g,b),p=M(a,m,u)),c.has(a[m]))if(c.has(a[u])){const e=p.get(l[g]),t=void 0!==e?r[e]:null;if(null===t){const e=C(o,r[m]);k(e,d[g]),n[g]=e}else n[g]=k(t,d[g]),A(o,t,r[m]),r[e]=null;g++}else R(r[u]),u--;else R(r[m]),m++;for(;g<=b;){const e=C(o,n[b+1]);k(e,d[g]),n[g++]=e}for(;m<=u;){const e=r[m++];null!==e&&R(e)}I.set(o,n),B.set(o,l)}}),z=new WeakMap,P=e(e=>t=>{const o=z.get(t);if(void 0===e&&t instanceof r){if(void 0!==o||!z.has(t)){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else e!==o&&t.setValue(e);z.set(t,e)}),T=b`<dom-module id="lumo-tab" theme-for="vaadin-tab">
  <template>
    <style>
      :host {
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/;class q extends(p(h(L(v)))){static get template(){return b`
    <slot></slot>
`}static get is(){return"vaadin-tab"}static get version(){return"3.2.0"}ready(){super.ready(),this.setAttribute("role","tab")}_onKeyup(e){const t=this.hasAttribute("active");if(super._onKeyup(e),t){const e=this.querySelector("a");e&&e.click()}}}customElements.define(q.is,q);const j=b`<dom-module id="lumo-tabs" theme-for="vaadin-tabs">
  <template>
    <style>
      :host {
...
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/,D=/Apple.* Version\/(9|10)/.test(navigator.userAgent);class U extends(p(N(h(_([E],v))))){static get template(){return b`
    <style>
      :host {
        display: flex;
        align-items: center;
...
`}static get is(){return"vaadin-tabs"}static get version(){return"3.2.0"}static get properties(){return{orientation:{value:"horizontal",type:String},selected:{value:0,type:Number}}}static get observers(){return["_updateOverflow(items.*, vertical)"]}ready(){super.ready(),this.addEventListener("iron-resize",()=>this._updateOverflow()),this._scrollerElement.addEventListener("scroll",()=>this._updateOverflow()),this.setAttribute("role","tablist"),x(this,()=>{this._updateOverflow()})}_scrollForward(){this._scroll(-this.__direction*this._scrollOffset)}_scrollBack(){this._scroll(this.__direction*this._scrollOffset)}get _scrollOffset(){return this._vertical?this._scrollerElement.offsetHeight:this._scrollerElement.offsetWidth}get _scrollerElement(){return this.$.scroll}get __direction(){return this._vertical||"rtl"!==this.getAttribute("dir")?-1:1}_updateOverflow(){const e=this._vertical?this._scrollerElement.scrollTop:this.__getNormalizedScrollLeft(this._scrollerElement);let t=this._vertical?this._scrollerElement.scrollHeight:this._scrollerElement.scrollWidth;t-=1;let o=e>0?"start":"";o+=e+this._scrollOffset<t?" end":"",1==this.__direction&&(o=o.replace(/start|end/gi,e=>"start"===e?"end":"start")),o?this.setAttribute("overflow",o.trim()):this.removeAttribute("overflow"),this._repaintShadowNodesHack()}_repaintShadowNodesHack(){if(D&&this.root){const e="-webkit-backface-visibility";this.root.querySelectorAll("*").forEach(t=>{t.style[e]="visible",t.style[e]=""})}}}customElements.define(U.is,U);class F extends a{static get styles(){return n`
        ...
        <paper-dialog id="modal">
            ...
            <div class="buttons">
                <paper-button dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isConfirm()}">${$("dialogs.close")}</paper-button>
                <paper-button id="confirm" dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isMessage()}">${$("dialogs.yes")}</paper-button>
                <paper-button id="reject" dialog-confirm="dialog-confirm" autofocus="autofocus" ?hidden="${this.isMessage()}">${$("dialogs.no")}</paper-button>
            </div>
        </paper-dialog>
                ...
                <paper-card class="metadata">
                    <pb-collapse id="meta">
                        ...
                        <div slot="collapse-content">
                            ...
                            <paper-input id="description" name="description" .value="${P(this.description)}" label="${$("odd.editor.description-label")}"
